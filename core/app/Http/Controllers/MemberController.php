...
class MemberController extends Controller
{
    ...
    public function home()
    {
        ...
        return view(activeTemplate() . 'member.dashboard', compact('page_title'), $data);
    }
    ...
    public function show2faForm()
    {
        ...
        return view(activeTemplate() . 'member.go2fa', compact('page_title', 'secret', 'qrCodeUrl', 'prevcode', 'prevqr'));
    }
