                ...
                <table class="table align-items-center table-light">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if(request()->routeIs('admin.withdraw.pending'))
                            <td>
                                <button class="btn btn-success approveBtn" data-id="{{ $withdraw->id }}" data-amount="{{ $withdraw->currency }}{{ formatter_money($withdraw->amount) }}" data-username="{{ $withdraw->user->username }}"><i class="fa fa-fw fa-check"></i></button>
                                <button class="btn btn-danger rejectBtn" data-id="{{ $withdraw->id }}" data-amount="{{ $withdraw->currency }}{{ formatter_money($withdraw->amount) }}" data-username="{{ $withdraw->user->username }}"><i class="fa fa-fw fa-ban"></i></button>
