    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body text-center border-bottom">
                <img src="{{ get_image(config('constants.user.profile.path') .'/'. $user->image) }}" alt="profile-image"
                    class="user-image">
            ...
            <div class="card-body">
                <p class="clearfix">
                    ...
                    <span class="float-right font-weight-bold"><a
                            href="{{ route('admin.users.detail', $user->id) }}">{{ $user->username }}</a></span>
                </p>
                <p class="clearfix">
                ...
                <p class="clearfix">
                    ...
                    <span
                        class="float-right text-muted">{{ $general->cur_sym }}{{ formatter_money($user->balance) }}</span>
                </p>
                <p class="clearfix">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body text-left">
                                    <h4 class="mb-0 text-success">{{ $general->cur_text}}
                {{ formatter_money($withdrawals->total) }}</h4>
...
<div class="col-lg-4">
    <div class="card outline-dark">
        <div class="card-body">
            <div class="media align-items-center">
                <div class="media-body text-left">
                    <h4 class="mb-0 text-dark">{{ $general->cur_text}}
                        {{ formatter_money($deposits->total) }}</h4>
...
<form action="{{ route('admin.users.update', $user->id) }}" method="POST">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <br>
            <small>Street</small>
            <input class="form-control" type="text" value="{{ $user->address->address }}" name="address"
                placeholder="Street">
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-lg-3">
                <small>City</small>
                <input class="form-control" type="text" value="{{ $user->address->city }}" name="city"
                    placeholder="City">
            </div>
            <div class="form-group col-lg-3">
                <small>State</small>
                <input class="form-control" type="text" value="{{ $user->address->state }}" name="state"
                    placeholder="State">
            </div>
            <div class="form-group col-lg-3">
                <small>Zip/Postal</small>
                <input class="form-control" type="text" value="{{ $user->address->zip }}" name="zip"
        ...
        <div class="form-row">
            <div class="form-group col-lg-4">
                ...
                <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger"
                    data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Active"
                    data-off="Banned" data-width="100%" name="status" @if($user->status) checked @endif>
            </div>
            ...
            <div class="form-group col-lg-6">
                ...
                <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger"
                    data-toggle="toggle" data-on="On" data-off="Off" name="ts" @if($user->ts) checked
                @endif>
            </div>
