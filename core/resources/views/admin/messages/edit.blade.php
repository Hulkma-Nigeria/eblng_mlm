                    ...
                    <div class="payment-method-item ">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3 mb-4">
                                <input type="text" class="form-control" placeholder="Title ..." name="title" value="{{ old('title') ?? $message->title }}" />
                            </div>
                        </div>
                                    ...
                                    <div class="card outline-dark">
                                        ...
                                        <div class="card-body mb-0 pb-0">
                                            <div class="form-group">
                                                <textarea id="body_1"
                                                          rows="8" class="form-control border-radius-5 " name="body_1">{{ old('body_1') ?? $message->body_1}}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="target" id="target" required class="form-control">
                                            ...
                                            <option value="member" {{$message->target == 'member'? 'selected': ''}}>Member</option>
                                            <option value="general" {{$message->target == 'general'? 'selected': ''}}>General</option>
                                            <option value="everyone" {{$message->target == 'everyone'? 'selected': ''}}>Everyone</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="checkbox"
                                               ...
                                               data-off="In active"
                                               data-width="100%"
                                               name="status" @if($message->status) checked @endif >
                                    </div>
                                </div>
