...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="33d9b2" data-before="218c74"
            ...
            <div class="details">
                <h2 class="amount mb-2 font-weight-bold">
                    {{ collect($widget['total_users'])->where('status', 1)->count() }}</h2>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="ff5252" data-before="b33939"
            ...
            <div class="details">
                <h2 class="amount mb-2 font-weight-bold">
                    {{ collect($widget['total_users'])->where('status', 0)->count() }}</h2>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="B33771" data-before="6D214F"
            ...
            <div class="details">
                <h3 class="amount mb-2 font-weight-bold">
                    {{ $general->cur_sym }}{{ formatter_money(collect($widget['total_users'])->sum('balance')) }}</h3>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="40407a" data-before="2c2c54"
            ...
            <div class="details">
                <h2 class="amount mb-2 font-weight-bold">{{ collect($widget['total_users'])->where('ev', 0)->count() }}
                </h2>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="34ace0" data-before="227093"
            ...
            <div class="details">
                <h2 class="amount mb-2 font-weight-bold">{{ collect($widget['total_users'])->where('sv', 0)->count() }}
                </h2>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="ff793f" data-before="cd6133"
            style="background: #ff793f; --before-bg-color:#cd6133;">
            <div class="details">
                <h2 class="amount mb-2 font-weight-bold">{{ $general->cur_sym }}{{ formatter_money($total_pu_plan) }}
                </h2>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="33d9b2" data-before="218c74"
            style="background: #33d9b2; --before-bg-color:#218c74;">
            <div class="details">
                <h2 class="amount mb-2 font-weight-bold">{{ $general->cur_sym }}{{ formatter_money($total_ref_get) }}
                </h2>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="B33771" data-before="6D214F"
            style="background: #B33771; --before-bg-color:#6D214F;">
            <div class="details">
                <h3 class="amount mb-2 font-weight-bold">{{ $general->cur_sym }}{{ formatter_money($total_ref_bonus) }}
                </h3>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="33d9b2" data-before="218c74"
            ...
            <div class="details">
                <h3 class="amount mb-2 font-weight-bold">
                    {{ $general->cur_sym }}{{ formatter_money($widget['deposits']->total_charge) }}</h3>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice border-radius-5" data-bg="ff5252" data-before="b33939"
            ...
            <div class="details">
                <h3 class="amount mb-2 font-weight-bold">
                    {{ $general->cur_sym }}{{ formatter_money($widget['deposits']->total_amount) }}</h3>
...
<div class="col-xl-4 col-lg-6 col-sm-6">
    <div class="dashboard-w2 slice border-radius-5" data-bg="40407a" data-before="2c2c54"
        ...
        <div class="details">
            <h3 class="amount mb-2 font-weight-bold">
                {{ $general->cur_sym }}{{ formatter_money($widget['withdrawals']->total_charge) }}</h3>
...
<div class="col-xl-4 col-lg-6 col-sm-6">
    <div class="dashboard-w2 slice border-radius-5" data-bg="34ace0" data-before="227093"
        ...
        <div class="details">
            <h3 class="amount mb-2 font-weight-bold">
                {{ $general->cur_sym }}{{ formatter_money($widget['withdrawals']->total_amount) }}</h3>
