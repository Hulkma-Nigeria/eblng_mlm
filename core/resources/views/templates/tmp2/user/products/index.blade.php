...
<div class="product-grid p-2 text-left">
    <div class="form-group">
        ...
        <input name="buyer_username" value="{{old('buyer_username') ?? $buyer}}" class="form-control"
            id="buyer_username" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="other_info"
            id="info">{{ old('other_info') ?? $cart->other_info}}</textarea>
    </div>
    <div class="pt-1 pb-4">
        <p>Account: {{$balance}}</p>
...
<div class="col-md-4 col-sm-2">
    <form action="{{ route('user.checkout') }}" class="" method="post">
        {{ csrf_field() }}
        <cart-summary-component :balance="'{{$balance}}'" :cart-total="'{{$cartTotal}}'"
            :point-value="'{{$pointValue}}'"></cart-summary-component>
    </form>
</div>
</div>
</div>
