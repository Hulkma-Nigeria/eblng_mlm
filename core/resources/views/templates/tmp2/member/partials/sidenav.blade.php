    ...
    <div id="main-sidebar">
        <ul class="nav">
            ...
            <li class="nav-item {{ sidenav_active('member.deposit*') }}">
                ...
                <ul class="sub-menu">
                    <li class="nav-item {{ sidenav_active('member.deposit') }}">
                        <a class="nav-link" href="{{ route('member.deposit') }}">
            ...
            <li class="nav-item {{ sidenav_active('member.go2fa') }}">
                <a href="{{route('member.go2fa')}}" class="nav-link">
